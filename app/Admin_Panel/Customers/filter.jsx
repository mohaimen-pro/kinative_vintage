            ...
            <div className="filter_section bg-white mt-2">
                <div className="px-6 pt-8 flex items-center justify-between pb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="search flex border border-[#BDD7BD] rounded-[40px] w-[314px] px-6 py-3 items-start gap-4">
                ...
                <div className="filter_btn pb-4 px-6 flex items-center gap-2">
                    {
